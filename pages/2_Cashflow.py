...
def load_day_by_day_data(client, start_date):
    """
    Fetch and return day-by-day sums of 'due_amount' from 1 Oct onward.
...
def load_month_by_month_data(client, start_date):
    """
    Fetch and return month-year sums of 'due_amount' from 1 Oct onward
...
def main():
    # 1. Set page configuration with emoji and wide layout
    ...
    # 3. Determine the start of the current financial year
    ...
    # 9. Display month-by-month pivot table
